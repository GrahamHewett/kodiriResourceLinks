  ...
  <>
    <Section id="javascript" name="JavaScript">
      ...
      <Topic name="Books" parentId="javascript" index="1">
        ...
        <ResourceLink
          ...
          href="https://github.com/getify/You-Dont-Know-JS/find/master"
        />
        <ResourceLink
          text="JavaScript The Good Parts"
          href="http://shop.oreilly.com/product/9780596517748"
        />
        <ResourceLink
        ...
        />
        <ResourceLink
          text="Douglas Crockford Talk"
          href="https://www.youtube.com/watch?reload=9&v=v2ifWcnQs6M"
        />
      </Topic>
    ...
    <Section id="git" name="Git">
      <Topic name="Docs and Tutorials" parentId="git" index="0">
        ...
        <ResourceLink text="Asia giHub" href="https://github.com/asiksa" />

        <ResourceLink text="Official help" href="https://help.github.com/" />
        <ResourceLink
          text="Atlassian Tutorials"
          href="https://www.atlassian.com/git/tutorials"
        />
        <ResourceLink
          text="Git Immersion"
          href="http://gitimmersion.com/index.html"
        />
      </Topic>
      <Topic name="Git Commands" parentId="git" index="1">
        ...
        <ResourceLink
          text="Using Branches"
          href="https://backlog.com/git-tutorial/using-branches/"
        />
      </Topic>
      <Topic name="GitHub Collaboration" parentId="git" index="2">
        <ResourceLink
          text="Connecting with SSH"
          href="https://help.github.com/articles/connecting-to-github-with-ssh/"
        />
        <ResourceLink
          text="Forking and Pull Requests"
          href="https://www.gun.io/blog/how-to-github-fork-branch-and-pull-request"
        />
        <ResourceLink
          text="Track a branch"
          href="https://www.git-tower.com/learn/git/faq/track-remote-upstream-branch"
        />
      </Topic>
    </Section>
